...
export const ZONES: Zone[] = [
  {
    ...
    enemies: [], // Grievy Town est une ville neutre — pas d'ennemis
    bossId: '',
  ...
  },
  {
    ...
    enemies: ['ember_wyrm', 'lava_golem', 'cinder_sprite', 'ash_revenant', 'magma_titan', 'ember_broodmother', 'scorch_sentinel'],
    bossId: 'pyrath_boss',
  ...
  },
  {
    ...
    enemies: ['stone_crawler', 'crystal_golem', 'cave_lurker', 'terravast_serpent', 'ruin_colossus', 'rune_shard_ghost', 'stone_hound'],
    bossId: 'gorvun_boss',
  ...
  },
  {
    ...
    enemies: ['gale_harpy', 'storm_eagle', 'wind_wraith', 'cyclone_sprite', 'sky_titan', 'storm_caller', 'cloudpiercer'],
    bossId: 'sylvael_boss',
  ...
  },
  {
    ...
    recommendedLevel: 14,
    mapKey: 'map_abyssmar',
    enemies: ['tide_crawler', 'sea_wraith', 'coral_golem', 'depth_serpent', 'drowned_knight', 'tide_shaper', 'abyssal_shade'],
  ...
  },
  {
    ...
    recommendedLevel: 16,
    mapKey: 'map_volterra',
    enemies: ['spark_imp', 'thunder_drake', 'chain_revenant', 'volt_hound', 'storm_herald', 'arc_node', 'grid_architect'],
    bossId: 'volkran_boss',
  ...
  },
  {
    ...
    recommendedLevel: 18,
    mapKey: 'map_glaciem',
    enemies: ['frost_wolf', 'ice_golem', 'blizzard_wraith', 'permafrost_titan', 'crystal_dragon', 'glacial_shaper', 'hoarfrost_stalker'],
  ...
  },
  {
    ...
    enemies: ['dark_revenant', 'shadow_construct', 'void_sentinel', 'void_weaver', 'void_stalker'],
