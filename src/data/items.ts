...
export const EXTRA_WEAPONS: Weapon[] = [
  ...
  { id: 'test_dual_dagger', name: 'Lames Jumelles (Test)', description: 'Arme de test — double dague.',  rarity: ItemRarity.COMMON, type: ItemType.WEAPON, icon: 'item_shadow_dagger', value: 10, weaponType: WeaponType.DUAL_DAGGER, damage: 20, magicDamage: 0, bonusStats: {}, attackSpeed: 1.5 },
  { id: 'test_dual_sword',  name: 'Épées Doubles (Test)',  description: 'Arme de test — double épée.',   rarity: ItemRarity.COMMON, type: ItemType.WEAPON, icon: 'item_iron_sword',    value: 10, weaponType: WeaponType.DUAL_SWORD,  damage: 25, magicDamage: 0, bonusStats: {}, attackSpeed: 1.0 },
  { id: 'test_axe',         name: 'Hache (Test)',          description: 'Arme de test — hache.',         rarity: ItemRarity.COMMON, type: ItemType.WEAPON, icon: 'item_iron_sword',    value: 10, weaponType: WeaponType.AXE,         damage: 30, magicDamage: 0, bonusStats: {}, attackSpeed: 0.9 },
  { id: 'test_hammer',      name: 'Marteau (Test)',        description: 'Arme de test — marteau.',       rarity: ItemRarity.COMMON, type: ItemType.WEAPON, icon: 'item_iron_sword',    value: 10, weaponType: WeaponType.HAMMER,      damage: 35, magicDamage: 0, bonusStats: {}, attackSpeed: 0.7 },
