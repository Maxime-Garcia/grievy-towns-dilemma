...
export const WEAPONS: Weapon[] = [
  // Swords
  { id: 'iron_sword', name: 'Épée de Fer', description: 'Une lame basique en fer. Fiable.', rarity: ItemRarity.COMMON, type: ItemType.WEAPON, icon: 'item_iron_sword', value: 40, weaponType: WeaponType.SWORD, damage: 14, magicDamage: 0, bonusStats: {}, attackSpeed: 1.0, equipStats: { mainStat: { key: 'ATK_FLAT', value: 14 }, substats: [{ key: 'CRIT_RATE', value: 2, isPercentage: true }] } },
  { id: 'steel_sword', name: 'Épée d\'Acier', description: 'Une lame d\'acier bien forgée.', rarity: ItemRarity.UNCOMMON, type: ItemType.WEAPON, icon: 'item_steel_sword', value: 120, weaponType: WeaponType.SWORD, damage: 22, magicDamage: 0, bonusStats: { str: 1 }, attackSpeed: 1.0, equipStats: { mainStat: { key: 'ATK_FLAT', value: 22 }, substats: [{ key: 'CRIT_RATE', value: 3, isPercentage: true }, { key: 'ATK_PCT', value: 4, isPercentage: true }] } },
  { id: 'storm_sword', name: 'Épée de Tempête', description: 'Une lame qui crépite de l\'éclair de Volterra.', rarity: ItemRarity.RARE, type: ItemType.WEAPON, icon: 'item_storm_sword', value: 380, element: ElementType.LIGHTNING, weaponType: WeaponType.SWORD, damage: 30, magicDamage: 20, bonusStats: { str: 2, agi: 1 }, attackSpeed: 1.1, equipStats: { mainStat: { key: 'ATK_FLAT', value: 30 }, substats: [{ key: 'ELEM_BONUS_PCT', value: 8, isPercentage: true }, { key: 'ASPD_PCT', value: 6, isPercentage: true }, { key: 'CRIT_RATE', value: 4, isPercentage: true }] } },
  ...
  // Staffs
  { id: 'fire_staff', name: 'Sceptre de Braise', description: 'Un sceptre qui canalise la magie du feu.', rarity: ItemRarity.UNCOMMON, type: ItemType.WEAPON, icon: 'item_fire_staff', value: 150, element: ElementType.FIRE, weaponType: WeaponType.STAFF, damage: 5, magicDamage: 28, bonusStats: { int: 2 }, attackSpeed: 0.85, equipStats: { mainStat: { key: 'MATK_FLAT', value: 28 }, substats: [{ key: 'ELEM_BONUS_PCT', value: 8, isPercentage: true }, { key: 'MANA_FLAT', value: 15 }] } },
  ...
  // Bows
  { id: 'harpy_bow', name: 'Arc des Harpies', description: 'Léger comme une plume, précis dans le vent.', rarity: ItemRarity.UNCOMMON, type: ItemType.WEAPON, icon: 'item_harpy_bow', value: 180, element: ElementType.WIND, weaponType: WeaponType.BOW, damage: 18, magicDamage: 10, bonusStats: { agi: 2 }, attackSpeed: 1.3, equipStats: { mainStat: { key: 'ATK_FLAT', value: 18 }, substats: [{ key: 'ASPD_PCT', value: 10, isPercentage: true }, { key: 'CRIT_RATE', value: 3, isPercentage: true }] } },
...
export const ARMORS: Armor[] = [
  // Helms
  { id: 'leather_helm', name: 'Heaume de Cuir', description: 'Protection basique pour la tête.', rarity: ItemRarity.COMMON, type: ItemType.HELM, icon: 'item_leather_helm', value: 25, defense: 5, magicDefense: 2, bonusStats: {}, equipStats: { mainStat: { key: 'HP_PCT', value: 3, isPercentage: true }, substats: [{ key: 'DEF_FLAT', value: 2 }] } },
  { id: 'iron_helm', name: 'Heaume de Fer', description: 'Casque en fer standard.', rarity: ItemRarity.UNCOMMON, type: ItemType.HELM, icon: 'item_iron_helm', value: 80, defense: 12, magicDefense: 4, bonusStats: { end: 1 }, equipStats: { mainStat: { key: 'HP_PCT', value: 5, isPercentage: true }, substats: [{ key: 'HP_FLAT', value: 20 }, { key: 'DEF_FLAT', value: 4 }] } },
  ...
  // Chests
  { id: 'leather_chest', name: 'Plastron de Cuir', description: 'Protection basique pour le torse.', rarity: ItemRarity.COMMON, type: ItemType.CHEST, icon: 'item_leather_chest', value: 35, defense: 8, magicDefense: 3, bonusStats: {}, equipStats: { mainStat: { key: 'DEF_FLAT', value: 4 }, substats: [{ key: 'HP_FLAT', value: 15 }] } },
  { id: 'iron_chest', name: 'Plastron de Fer', description: 'Plastron en fer standard.', rarity: ItemRarity.UNCOMMON, type: ItemType.CHEST, icon: 'item_iron_chest', value: 110, defense: 20, magicDefense: 6, bonusStats: { end: 1 }, equipStats: { mainStat: { key: 'DEF_FLAT', value: 8 }, substats: [{ key: 'HP_FLAT', value: 30 }, { key: 'DEF_PCT', value: 4, isPercentage: true }] } },
  ...
  // Boots
  { id: 'leather_boots', name: 'Bottes de Cuir', description: 'Protection basique pour les pieds.', rarity: ItemRarity.COMMON, type: ItemType.BOOTS, icon: 'item_leather_boots', value: 20, defense: 3, magicDefense: 1, bonusStats: {}, equipStats: { mainStat: { key: 'SPD_FLAT', value: 3 }, substats: [{ key: 'DEF_FLAT', value: 2 }] } },
...
export const ACCESSORIES: Accessory[] = [
  // Rings
  { id: 'flame_ring', name: 'Anneau des Braises', description: 'Dégâts de feu +5%.', rarity: ItemRarity.UNCOMMON, type: ItemType.RING, icon: 'item_flame_ring', value: 200, element: ElementType.FIRE, bonusStats: { int: 2, magicAtk: 3 }, equipStats: { mainStat: { key: 'MATK_FLAT', value: 8 }, substats: [{ key: 'ELEM_BONUS_PCT', value: 5, isPercentage: true }, { key: 'MANA_FLAT', value: 12 }] } },
  { id: 'sailor_ghost_ring', name: 'Anneau du Marin Perdu', description: 'Porté par un marin qui s\'est noyé dans Abyssmar.', rarity: ItemRarity.RARE, type: ItemType.RING, icon: 'item_sailor_ring', value: 500, element: ElementType.WATER, bonusStats: { int: 3, vit: 2 }, passiveEffect: 'Breathing underwater lasts 50% longer.', equipStats: { mainStat: { key: 'HP_FLAT', value: 60 }, substats: [{ key: 'MATK_FLAT', value: 10 }, { key: 'MANA_FLAT', value: 20 }, { key: 'ELEM_BONUS_PCT', value: 5, isPercentage: true }] } },
  ...
  { id: 'shadow_ring', name: 'Anneau des Ombres', description: 'Froid au toucher. A toujours été froid.', rarity: ItemRarity.RARE, type: ItemType.RING, icon: 'item_shadow_ring', value: 420, element: ElementType.DARK, bonusStats: { agi: 3, int: 3 }, equipStats: { mainStat: { key: 'MATK_FLAT', value: 12 }, substats: [{ key: 'CRIT_RATE', value: 4, isPercentage: true }, { key: 'ELEM_BONUS_PCT', value: 6, isPercentage: true }, { key: 'SPD_FLAT', value: 3 }] } },
  ...
  // Amulets
  { id: 'wraith_ice_amulet', name: 'Amulette du Fantôme Blizzard', description: 'Le froid de Glaciem sous forme condensée.', rarity: ItemRarity.RARE, type: ItemType.AMULET, icon: 'item_blizzard_amulet', value: 500, element: ElementType.ICE, bonusStats: { int: 4, end: 2 }, equipStats: { mainStat: { key: 'MATK_FLAT', value: 14 }, substats: [{ key: 'ELEM_BONUS_PCT', value: 7, isPercentage: true }, { key: 'MANA_FLAT', value: 20 }, { key: 'HP_FLAT', value: 35 }] } },
...
export const EXTRA_WEAPONS: Weapon[] = [
  // Fire
  { id: 'cinder_dagger', name: 'Dague de Braise', description: 'Rapide et brûlante. Laisse une marque.', rarity: ItemRarity.RARE, type: ItemType.WEAPON, icon: 'item_cinder_dagger', value: 420, element: ElementType.FIRE, weaponType: WeaponType.DAGGER, damage: 28, magicDamage: 20, bonusStats: { agi: 4, int: 2 }, attackSpeed: 1.7, equipStats: { mainStat: { key: 'ATK_FLAT', value: 28 }, substats: [{ key: 'ASPD_PCT', value: 9, isPercentage: true }, { key: 'ELEM_BONUS_PCT', value: 8, isPercentage: true }, { key: 'CRIT_RATE', value: 4, isPercentage: true }] } },
  { id: 'pyroclast_bow', name: 'Arc Pyroclaste', description: 'Flèches incandescentes qui explosent à l\'impact.', rarity: ItemRarity.EPIC, type: ItemType.WEAPON, icon: 'item_pyroclast_bow', value: 1900, element: ElementType.FIRE, weaponType: WeaponType.BOW, damage: 60, magicDamage: 50, bonusStats: { agi: 6, int: 4 }, attackSpeed: 1.0, equipStats: { mainStat: { key: 'ATK_FLAT', value: 60 }, substats: [{ key: 'ELEM_BONUS_PCT', value: 12, isPercentage: true }, { key: 'CRIT_RATE', value: 6, isPercentage: true }, { key: 'CRIT_DMG', value: 15, isPercentage: true }, { key: 'ASPD_PCT', value: 6, isPercentage: true }] } },
  // Earth
  { id: 'stone_dagger', name: 'Dague de Pierre', description: 'Taillée dans le cristal de Terravast. Tranchante.', rarity: ItemRarity.RARE, type: ItemType.WEAPON, icon: 'item_stone_dagger', value: 380, element: ElementType.EARTH, weaponType: WeaponType.DAGGER, damage: 30, magicDamage: 12, bonusStats: { str: 3, end: 2 }, attackSpeed: 1.5, equipStats: { mainStat: { key: 'ATK_FLAT', value: 30 }, substats: [{ key: 'ASPD_PCT', value: 6, isPercentage: true }, { key: 'DEF_FLAT', value: 8 }, { key: 'ELEM_BONUS_PCT', value: 7, isPercentage: true }] } },
  { id: 'seismic_staff', name: 'Sceptre Sismique', description: 'Chaque frappe fait trembler le sol.', rarity: ItemRarity.EPIC, type: ItemType.WEAPON, icon: 'item_seismic_staff', value: 1750, element: ElementType.EARTH, weaponType: WeaponType.STAFF, damage: 10, magicDamage: 88, bonusStats: { int: 7, end: 3 }, attackSpeed: 0.88, equipStats: { mainStat: { key: 'MATK_FLAT', value: 88 }, substats: [{ key: 'ELEM_BONUS_PCT', value: 12, isPercentage: true }, { key: 'MATK_PCT', value: 8, isPercentage: true }, { key: 'MANA_FLAT', value: 35 }, { key: 'DEF_FLAT', value: 10 }] } },
  // Wind
  { id: 'gale_dagger', name: 'Dague du Vent', description: 'Si légère qu\'elle semble flotter.', rarity: ItemRarity.RARE, type: ItemType.WEAPON, icon: 'item_gale_dagger', value: 460, element: ElementType.WIND, weaponType: WeaponType.DAGGER, damage: 20, magicDamage: 25, bonusStats: { agi: 5 }, attackSpeed: 1.8, equipStats: { mainStat: { key: 'ATK_FLAT', value: 20 }, substats: [{ key: 'ASPD_PCT', value: 12, isPercentage: true }, { key: 'SPD_FLAT', value: 4 }, { key: 'CRIT_RATE', value: 4, isPercentage: true }] } },
  { id: 'wind_greatsword', name: 'Espadon des Rafales', description: 'Aussi tranchant que le vent lui-même.', rarity: ItemRarity.RARE, type: ItemType.WEAPON, icon: 'item_wind_greatsword', value: 490, element: ElementType.WIND, weaponType: WeaponType.GREATSWORD, damage: 65, magicDamage: 22, bonusStats: { str: 4, agi: 3 }, attackSpeed: 0.72, equipStats: { mainStat: { key: 'ATK_FLAT', value: 65 }, substats: [{ key: 'ELEM_BONUS_PCT', value: 8, isPercentage: true }, { key: 'ASPD_PCT', value: 6, isPercentage: true }, { key: 'CRIT_RATE', value: 3, isPercentage: true }] } },
  // Water
  { id: 'tide_staff', name: 'Bâton des Marées', description: 'Pulse comme un courant sous-marin.', rarity: ItemRarity.RARE, type: ItemType.WEAPON, icon: 'item_tide_staff', value: 410, element: ElementType.WATER, weaponType: WeaponType.STAFF, damage: 6, magicDamage: 68, bonusStats: { int: 5, vit: 3 }, attackSpeed: 0.9, equipStats: { mainStat: { key: 'MATK_FLAT', value: 68 }, substats: [{ key: 'ELEM_BONUS_PCT', value: 9, isPercentage: true }, { key: 'MANA_FLAT', value: 25 }, { key: 'HP_FLAT', value: 40 }] } },
  { id: 'coral_sword', name: 'Épée de Corail', description: 'Forgée dans les profondeurs d\'Abyssmar.', rarity: ItemRarity.UNCOMMON, type: ItemType.WEAPON, icon: 'item_coral_sword', value: 200, element: ElementType.WATER, weaponType: WeaponType.SWORD, damage: 26, magicDamage: 14, bonusStats: { end: 2 }, attackSpeed: 1.0, equipStats: { mainStat: { key: 'ATK_FLAT', value: 26 }, substats: [{ key: 'ELEM_BONUS_PCT', value: 6, isPercentage: true }, { key: 'DEF_FLAT', value: 5 }] } },
  // Lightning
  { id: 'arc_sword', name: 'Épée Arc Électrique', description: 'Inflige un choc à chaque touche.', rarity: ItemRarity.RARE, type: ItemType.WEAPON, icon: 'item_arc_sword', value: 440, element: ElementType.LIGHTNING, weaponType: WeaponType.SWORD, damage: 32, magicDamage: 28, bonusStats: { agi: 3, str: 2 }, attackSpeed: 1.15, equipStats: { mainStat: { key: 'ATK_FLAT', value: 32 }, substats: [{ key: 'ELEM_BONUS_PCT', value: 9, isPercentage: true }, { key: 'ASPD_PCT', value: 8, isPercentage: true }, { key: 'CRIT_RATE', value: 3, isPercentage: true }] } },
  { id: 'thunder_bow', name: 'Arc du Tonnerre', description: 'Les flèches laissent une traîne de foudre.', rarity: ItemRarity.EPIC, type: ItemType.WEAPON, icon: 'item_thunder_bow', value: 1850, element: ElementType.LIGHTNING, weaponType: WeaponType.BOW, damage: 52, magicDamage: 55, bonusStats: { agi: 6, int: 4 }, attackSpeed: 1.2, equipStats: { mainStat: { key: 'ATK_FLAT', value: 52 }, substats: [{ key: 'ELEM_BONUS_PCT', value: 12, isPercentage: true }, { key: 'ASPD_PCT', value: 10, isPercentage: true }, { key: 'CRIT_RATE', value: 5, isPercentage: true }, { key: 'MATK_FLAT', value: 18 }] } },
  // Ice
  { id: 'frost_dagger', name: 'Dague du Givre', description: 'Gèle les plaies qu\'elle inflige.', rarity: ItemRarity.RARE, type: ItemType.WEAPON, icon: 'item_frost_dagger', value: 430, element: ElementType.ICE, weaponType: WeaponType.DAGGER, damage: 22, magicDamage: 26, bonusStats: { agi: 3, int: 3 }, attackSpeed: 1.6, equipStats: { mainStat: { key: 'ATK_FLAT', value: 22 }, substats: [{ key: 'ASPD_PCT', value: 9, isPercentage: true }, { key: 'ELEM_BONUS_PCT', value: 8, isPercentage: true }, { key: 'MATK_FLAT', value: 10 }] } },
  { id: 'blizzard_greatsword', name: 'Espadon des Blizzards', description: 'Laisse derrière lui un sillage de glace.', rarity: ItemRarity.EPIC, type: ItemType.WEAPON, icon: 'item_blizzard_gs', value: 1650, element: ElementType.ICE, weaponType: WeaponType.GREATSWORD, damage: 90, magicDamage: 40, bonusStats: { str: 7, int: 4, end: 3 }, attackSpeed: 0.62, equipStats: { mainStat: { key: 'ATK_FLAT', value: 90 }, substats: [{ key: 'ELEM_BONUS_PCT', value: 12, isPercentage: true }, { key: 'ATK_PCT', value: 8, isPercentage: true }, { key: 'CRIT_DMG', value: 18, isPercentage: true }, { key: 'HP_FLAT', value: 70 }] } },
  // Dark
  { id: 'shadow_staff', name: 'Sceptre des Ombres', description: 'Semble absorber la lumière environnante.', rarity: ItemRarity.EPIC, type: ItemType.WEAPON, icon: 'item_shadow_staff', value: 2100, element: ElementType.DARK, weaponType: WeaponType.STAFF, damage: 15, magicDamage: 95, bonusStats: { int: 8, agi: 3 }, attackSpeed: 0.95, equipStats: { mainStat: { key: 'MATK_FLAT', value: 95 }, substats: [{ key: 'ELEM_BONUS_PCT', value: 12, isPercentage: true }, { key: 'MATK_PCT', value: 9, isPercentage: true }, { key: 'CRIT_RATE', value: 5, isPercentage: true }, { key: 'LIFESTEAL_PCT', value: 3, isPercentage: true }] } },
  { id: 'void_bow', name: 'Arc du Vide', description: 'Les flèches disparaissent. Les ennemis aussi.', rarity: ItemRarity.EPIC, type: ItemType.WEAPON, icon: 'item_void_bow', value: 2200, element: ElementType.DARK, weaponType: WeaponType.BOW, damage: 58, magicDamage: 60, bonusStats: { agi: 7, int: 5 }, attackSpeed: 1.1, equipStats: { mainStat: { key: 'ATK_FLAT', value: 58 }, substats: [{ key: 'ELEM_BONUS_PCT', value: 12, isPercentage: true }, { key: 'CRIT_DMG', value: 18, isPercentage: true }, { key: 'LIFESTEAL_PCT', value: 3, isPercentage: true }, { key: 'ASPD_PCT', value: 6, isPercentage: true }] } },
  // Divine
  ...
  // Test weapons — one per WeaponType absent from the rest of the data, for dev inventory
  { id: 'test_dual_dagger', name: 'Lames Jumelles (Test)', description: 'Arme de test — double dague.',  rarity: ItemRarity.COMMON, type: ItemType.WEAPON, icon: 'item_shadow_dagger', value: 10, weaponType: WeaponType.DUAL_DAGGER, damage: 20, magicDamage: 0, bonusStats: {}, attackSpeed: 1.5, equipStats: { mainStat: { key: 'ATK_FLAT', value: 20 }, substats: [{ key: 'ASPD_PCT', value: 6, isPercentage: true }] } },
  { id: 'test_dual_sword',  name: 'Épées Doubles (Test)',  description: 'Arme de test — double épée.',   rarity: ItemRarity.COMMON, type: ItemType.WEAPON, icon: 'item_iron_sword',    value: 10, weaponType: WeaponType.DUAL_SWORD,  damage: 25, magicDamage: 0, bonusStats: {}, attackSpeed: 1.0, equipStats: { mainStat: { key: 'ATK_FLAT', value: 25 }, substats: [{ key: 'CRIT_RATE', value: 2, isPercentage: true }] } },
  { id: 'test_axe',         name: 'Hache (Test)',          description: 'Arme de test — hache.',         rarity: ItemRarity.COMMON, type: ItemType.WEAPON, icon: 'item_iron_sword',    value: 10, weaponType: WeaponType.AXE,         damage: 30, magicDamage: 0, bonusStats: {}, attackSpeed: 0.9, equipStats: { mainStat: { key: 'ATK_FLAT', value: 30 }, substats: [{ key: 'ATK_PCT', value: 3, isPercentage: true }] } },
  { id: 'test_hammer',      name: 'Marteau (Test)',        description: 'Arme de test — marteau.',       rarity: ItemRarity.COMMON, type: ItemType.WEAPON, icon: 'item_iron_sword',    value: 10, weaponType: WeaponType.HAMMER,      damage: 35, magicDamage: 0, bonusStats: {}, attackSpeed: 0.7, equipStats: { mainStat: { key: 'ATK_FLAT', value: 35 }, substats: [{ key: 'HP_FLAT', value: 25 }] } },
  // Zone chest rewards (referenced by zoneMaps lootable pools)
  { id: 'wind_bow',      name: 'Arc des Sommets',     description: 'Léger comme l\'air de Zephyr Peaks.',       rarity: ItemRarity.UNCOMMON, type: ItemType.WEAPON, icon: 'item_wind_bow',      value: 220, element: ElementType.WIND,      weaponType: WeaponType.BOW,   damage: 30, magicDamage: 18, bonusStats: { agi: 3 }, attackSpeed: 1.3, equipStats: { mainStat: { key: 'ATK_FLAT', value: 30 }, substats: [{ key: 'ASPD_PCT', value: 8, isPercentage: true }, { key: 'ELEM_BONUS_PCT', value: 6, isPercentage: true }] } },
  { id: 'water_staff',   name: 'Bâton des Abysses',   description: 'Murmure de l\'eau profonde.',               rarity: ItemRarity.UNCOMMON, type: ItemType.WEAPON, icon: 'item_water_staff',   value: 200, element: ElementType.WATER,     weaponType: WeaponType.STAFF, damage: 4,  magicDamage: 40, bonusStats: { int: 3 }, attackSpeed: 0.9, equipStats: { mainStat: { key: 'MATK_FLAT', value: 40 }, substats: [{ key: 'ELEM_BONUS_PCT', value: 6, isPercentage: true }, { key: 'MANA_FLAT', value: 18 }] } },
  { id: 'thunder_staff', name: 'Sceptre de Foudre',   description: 'Attire les éclairs de Volterra.',           rarity: ItemRarity.UNCOMMON, type: ItemType.WEAPON, icon: 'item_thunder_staff', value: 240, element: ElementType.LIGHTNING, weaponType: WeaponType.STAFF, damage: 5,  magicDamage: 45, bonusStats: { int: 4 }, attackSpeed: 0.9, equipStats: { mainStat: { key: 'MATK_FLAT', value: 45 }, substats: [{ key: 'ELEM_BONUS_PCT', value: 7, isPercentage: true }, { key: 'CRIT_RATE', value: 2, isPercentage: true }] } },
  { id: 'frost_staff',   name: 'Sceptre de Givre',    description: 'Chaque frappe refroidit l\'adversaire.',    rarity: ItemRarity.UNCOMMON, type: ItemType.WEAPON, icon: 'item_frost_staff',   value: 230, element: ElementType.ICE,       weaponType: WeaponType.STAFF, damage: 4,  magicDamage: 42, bonusStats: { int: 3, vit: 1 }, attackSpeed: 0.88, equipStats: { mainStat: { key: 'MATK_FLAT', value: 42 }, substats: [{ key: 'ELEM_BONUS_PCT', value: 6, isPercentage: true }, { key: 'HP_FLAT', value: 30 }] } },
  { id: 'earth_tome',    name: 'Tome de la Terre',    description: 'Recueil de sorts géomantiques de Terravast.',rarity: ItemRarity.UNCOMMON, type: ItemType.WEAPON, icon: 'item_earth_tome',    value: 210, element: ElementType.EARTH,     weaponType: WeaponType.STAFF, damage: 4,  magicDamage: 38, bonusStats: { int: 3, end: 1 }, attackSpeed: 0.85, equipStats: { mainStat: { key: 'MATK_FLAT', value: 38 }, substats: [{ key: 'ELEM_BONUS_PCT', value: 6, isPercentage: true }, { key: 'DEF_FLAT', value: 6 }] } },
];
...
export const EXTRA_ARMORS: Armor[] = [
  // Legs
  { id: 'leather_legs', name: 'Jambières de Cuir', description: 'Protection basique pour les jambes.', rarity: ItemRarity.COMMON, type: ItemType.LEGS, icon: 'item_leather_legs', value: 22, defense: 5, magicDefense: 2, bonusStats: {}, equipStats: { mainStat: { key: 'DEF_FLAT', value: 3 }, substats: [{ key: 'SPD_FLAT', value: 2 }] } },
  ...
  // Gloves extra
  { id: 'leather_gloves', name: 'Gants de Cuir', description: 'Protection basique des mains.', rarity: ItemRarity.COMMON, type: ItemType.GLOVES, icon: 'item_leather_gloves', value: 18, defense: 3, magicDefense: 1, bonusStats: {}, equipStats: { mainStat: { key: 'CRIT_RATE', value: 2, isPercentage: true }, substats: [{ key: 'ATK_FLAT', value: 3 }] } },
