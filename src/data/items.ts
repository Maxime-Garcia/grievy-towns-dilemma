...
export const WEAPONS: Weapon[] = [
  // Swords
  { id: 'iron_sword', lore: 'Forgée par dizaines à Grievy Town. La plupart n\'ont jamais servi. Celle-ci, si.', name: 'Épée de Fer', description: 'Une lame basique en fer. Fiable.', rarity: ItemRarity.COMMON, type: ItemType.WEAPON, icon: 'item_iron_sword', value: 40, weaponType: WeaponType.SWORD, damage: 14, magicDamage: 0, bonusStats: {}, attackSpeed: 1.0, equipRanges: { mainStat: { key: 'ATK_FLAT', min: 13, max: 15 }, substats: [{ key: 'CRIT_RATE', min: 2, max: 3, isPercentage: true }] } },
  ...
  // Staffs
  { id: 'fire_staff', lore: 'Les prêtres de Pyrath en donnaient aux pèlerins pour la traversée. La flamme ne devait servir qu\'à éclairer.', name: 'Sceptre de Braise', description: 'Un sceptre qui canalise la magie du feu.', rarity: ItemRarity.UNCOMMON, type: ItemType.WEAPON, icon: 'item_fire_staff', value: 150, element: ElementType.FIRE, weaponType: WeaponType.STAFF, damage: 5, magicDamage: 28, bonusStats: { int: 2 }, attackSpeed: 0.85, equipRanges: { mainStat: { key: 'MATK_FLAT', min: 24, max: 32 }, substats: [{ key: 'ELEM_BONUS_PCT', min: 7, max: 9, isPercentage: true }, { key: 'MANA_FLAT', min: 13, max: 17 }] } },
  { id: 'leviathan_staff', name: 'Sceptre du Léviathan', description: 'Sculpté dans un os de la forme antique de Thalymor. Imprégné de magie océanique.', rarity: ItemRarity.EPIC, type: ItemType.WEAPON, icon: 'item_leviathan_staff', value: 1800, element: ElementType.WATER, weaponType: WeaponType.STAFF, damage: 8, magicDamage: 80, bonusStats: { int: 7, vit: 3 }, attackSpeed: 0.9, lore: 'Thalymor perdait des os comme la mer perd de l\'écume. Celui-ci s\'est échoué il y a quatre cents ans.', equipRanges: { mainStat: { key: 'MATK_FLAT', min: 60, max: 100 }, substats: [{ key: 'MATK_PCT', min: 5, max: 9, isPercentage: true }, { key: 'ELEM_BONUS_PCT', min: 8, max: 14, isPercentage: true }, { key: 'MANA_FLAT', min: 21, max: 35 }, { key: 'HP_FLAT', min: 47, max: 79 }] } },
  { id: 'memory_staff', name: 'Sceptre des Souvenirs', description: 'Chaque frappe ralentit la cible tandis que ses souvenirs refont surface.', rarity: ItemRarity.LEGENDARY, type: ItemType.WEAPON, icon: 'item_memory_staff', value: 7000, element: ElementType.ICE, weaponType: WeaponType.STAFF, damage: 10, magicDamage: 110, bonusStats: { int: 10, end: 4 }, attackSpeed: 0.95, lore: 'Crysthea préservait les souvenirs. Ce sceptre le fait encore.', equipRanges: { mainStat: { key: 'MATK_FLAT', min: 77, max: 143 }, substats: [{ key: 'MATK_PCT', min: 7, max: 12, isPercentage: true }, { key: 'ELEM_BONUS_PCT', min: 11, max: 20, isPercentage: true }, { key: 'CDR_PCT', min: 5, max: 10, isPercentage: true }, { key: 'MANA_FLAT', min: 27, max: 49 }, { key: 'MDEF_FLAT', min: 11, max: 20 }] } },
  { id: 'crystal_dragon_fang_staff', lore: 'La dent s\'est brisée il y a des siècles et n\'a jamais tiédi. Certaines choses de Glaciem refusent de finir.', name: 'Sceptre-Croc de Cristal', description: 'Taillé dans la dent brisée d\'un dragon de cristal. Froid et tranchant.', rarity: ItemRarity.EPIC, type: ItemType.WEAPON, icon: 'item_crystal_staff', value: 2200, element: ElementType.ICE, weaponType: WeaponType.STAFF, damage: 12, magicDamage: 90, bonusStats: { int: 8, agi: 2 }, attackSpeed: 1.0, equipRanges: { mainStat: { key: 'MATK_FLAT', min: 68, max: 113 }, substats: [{ key: 'ELEM_BONUS_PCT', min: 8, max: 14, isPercentage: true }, { key: 'CRIT_RATE', min: 4, max: 7, isPercentage: true }, { key: 'MATK_PCT', min: 5, max: 9, isPercentage: true }, { key: 'MANA_FLAT', min: 21, max: 35 }] } },
  ...
  { id: 'malachars_staff', name: 'Sceptre de Malachar', description: 'Le sceptre qui a lancé la Malédiction du Délitement. Il vibre du souvenir de chaque puissance élémentaire.', rarity: ItemRarity.MYTHIC, type: ItemType.WEAPON, icon: 'item_malachars_staff', value: 25000, element: ElementType.DARK, weaponType: WeaponType.STAFF, damage: 20, magicDamage: 160, bonusStats: { int: 15, end: 5, vit: 5 }, attackSpeed: 1.1, lore: 'Malachar l\'a porté trente ans. Il ne l\'a jamais posé. Pas une seule fois.', equipRanges: { mainStat: { key: 'MATK_FLAT', min: 104, max: 216 }, substats: [{ key: 'MATK_PCT', min: 8, max: 17, isPercentage: true }, { key: 'ELEM_BONUS_PCT', min: 13, max: 27, isPercentage: true }, { key: 'MANA_FLAT', min: 33, max: 68 }, { key: 'CDR_PCT', min: 7, max: 14, isPercentage: true }, { key: 'CRIT_DMG', min: 16, max: 34, isPercentage: true }, { key: 'LIFESTEAL_PCT', min: 3, max: 7, isPercentage: true }] } },

  // Bows
  { id: 'harpy_bow', lore: 'Les harpies escortaient les voyageurs égarés, autrefois. Cet arc est fait de ce qu\'elles ont laissé tomber en chemin.', name: 'Arc des Harpies', description: 'Léger comme une plume, précis dans le vent.', rarity: ItemRarity.UNCOMMON, type: ItemType.WEAPON, icon: 'item_harpy_bow', value: 180, element: ElementType.WIND, weaponType: WeaponType.BOW, damage: 18, magicDamage: 10, bonusStats: { agi: 2 }, attackSpeed: 1.3, equipRanges: { mainStat: { key: 'ATK_FLAT', min: 15, max: 21 }, substats: [{ key: 'ASPD_PCT', min: 9, max: 12, isPercentage: true }, { key: 'CRIT_RATE', min: 3, max: 4, isPercentage: true }] } },
...
export const ARMORS: Armor[] = [
  ...
  { id: 'titan_helm', name: 'Heaume du Titan Magma', description: 'Sculpté dans le crâne d\'un Titan de Magma. Extrêmement chaud à porter.', rarity: ItemRarity.RARE, type: ItemType.HELM, icon: 'item_titan_helm', value: 400, element: ElementType.FIRE, defense: 22, magicDefense: 8, bonusStats: { end: 2, vit: 1 }, lore: 'Les orbites sont restées vides. Ceux qui l\'ont porté disent qu\'elles regardent quand même.', equipRanges: { mainStat: { key: 'HP_PCT', min: 5, max: 7, isPercentage: true }, substats: [{ key: 'DEF_FLAT', min: 6, max: 10 }, { key: 'HP_FLAT', min: 36, max: 54 }, { key: 'ELEM_BONUS_PCT', min: 6, max: 10, isPercentage: true }] } },
  ...
  { id: 'fire_chest', lore: 'L\'obsidienne se souvient de la coulée qui l\'a faite. Rien de plus chaud ne l\'inquiète.', name: 'Cuirasse d\'Ignis', description: 'Forgée dans l\'obsidienne d\'Ignis Reach. Résiste au feu.', rarity: ItemRarity.RARE, type: ItemType.CHEST, icon: 'item_fire_chest', value: 500, element: ElementType.FIRE, defense: 32, magicDefense: 14, bonusStats: { end: 2, vit: 2 }, equipRanges: { mainStat: { key: 'DEF_FLAT', min: 10, max: 14 }, substats: [{ key: 'HP_FLAT', min: 36, max: 54 }, { key: 'MDEF_FLAT', min: 6, max: 10 }, { key: 'ELEM_BONUS_PCT', min: 6, max: 10, isPercentage: true }] } },
  ...
  { id: 'coral_chest', lore: 'Le corail était vivant quand on l\'a taillé. Les artisans de Saltmourn jurent qu\'il l\'est encore un peu.', name: 'Cuirasse de Corail', description: 'Plaque de corail d\'Abyssmar. Légère et résistante à la magie d\'eau.', rarity: ItemRarity.RARE, type: ItemType.CHEST, icon: 'item_coral_chest', value: 520, element: ElementType.WATER, defense: 28, magicDefense: 20, bonusStats: { end: 2, int: 2 }, equipRanges: { mainStat: { key: 'MDEF_FLAT', min: 8, max: 12 }, substats: [{ key: 'HP_FLAT', min: 36, max: 54 }, { key: 'DEF_FLAT', min: 6, max: 10 }, { key: 'MANA_FLAT', min: 16, max: 24 }] } },
  ...
  { id: 'abyssal_chest', lore: 'Forgé sous l\'eau, à des pressions qu\'aucun poumon ne supporte. Personne ne demande comment.', name: 'Plastron Abyssal', description: 'Forgé du corail le plus profond et des écailles de Thalymor. Lourd comme le fond de l\'océan.', rarity: ItemRarity.LEGENDARY, type: ItemType.CHEST, icon: 'item_abyssal_chest', value: 8200, element: ElementType.WATER, defense: 70, magicDefense: 50, bonusStats: { end: 7, int: 5, vit: 4 }, equipRanges: { mainStat: { key: 'DEF_FLAT', min: 17, max: 31 }, substats: [{ key: 'MDEF_FLAT', min: 11, max: 20 }, { key: 'HP_FLAT', min: 60, max: 111 }, { key: 'MANA_FLAT', min: 27, max: 49 }, { key: 'HP_PCT', min: 7, max: 12, isPercentage: true }, { key: 'ELEM_BONUS_PCT', min: 11, max: 20, isPercentage: true }] } },
  ...
  { id: 'glaciem_guardian_chest', lore: 'La glace de Crysthea préserve ce qu\'elle enferme. Porter cette cuirasse, c\'est accepter d\'être gardé.', name: 'Cuirasse de Glaciem', description: 'Une glace si froide qu\'elle gèle les coups qui l\'atteignent.', rarity: ItemRarity.LEGENDARY, type: ItemType.CHEST, icon: 'item_glaciem_chest', value: 9000, element: ElementType.ICE, defense: 75, magicDefense: 55, bonusStats: { end: 8, vit: 5, int: 3 }, equipRanges: { mainStat: { key: 'DEF_FLAT', min: 18, max: 33 }, substats: [{ key: 'MDEF_FLAT', min: 11, max: 20 }, { key: 'HP_FLAT', min: 60, max: 111 }, { key: 'HP_PCT', min: 7, max: 12, isPercentage: true }, { key: 'DEF_PCT', min: 7, max: 12, isPercentage: true }, { key: 'DODGE_PCT', min: 4, max: 7, isPercentage: true }] } },
  ...
  { id: 'runic_armor', lore: 'Les runes forment une phrase de Gorvun que nul ne sait plus lire. Elle protège quand même.', name: 'Armure Runique', description: 'Plaques gravées de runes des profondeurs de Terravast.', rarity: ItemRarity.RARE, type: ItemType.CHEST, icon: 'item_runic_armor', value: 450, element: ElementType.EARTH, defense: 14, magicDefense: 6, bonusStats: { str: 6 }, equipRanges: { mainStat: { key: 'DEF_FLAT', min: 6, max: 10 }, substats: [{ key: 'ATK_FLAT', min: 8, max: 12 }, { key: 'HP_FLAT', min: 36, max: 54 }, { key: 'DEF_PCT', min: 4, max: 6, isPercentage: true }] } },
  ...
  // Gloves
  { id: 'obsidian_gauntlets', lore: 'Un lutteur d\'Ashford les portait aux tournois. Plus personne ne lui serrait la main.', name: 'Gantelets d\'Obsidienne', description: 'Gantelets lourds qui écrasent tout ce qu\'ils saisissent.', rarity: ItemRarity.RARE, type: ItemType.GLOVES, icon: 'item_obsidian_gauntlets', value: 420, element: ElementType.FIRE, defense: 18, magicDefense: 5, bonusStats: { str: 3 }, equipRanges: { mainStat: { key: 'ATK_PCT', min: 5, max: 7, isPercentage: true }, substats: [{ key: 'CRIT_RATE', min: 3, max: 5, isPercentage: true }, { key: 'ELEM_BONUS_PCT', min: 5, max: 7, isPercentage: true }, { key: 'DEF_FLAT', min: 5, max: 7 }] } },
...
export const ACCESSORIES: Accessory[] = [
  // Rings
  { id: 'flame_ring', lore: 'Les fiancés d\'Ashford s\'en offraient, avant. La braise tient plus longtemps que la plupart des promesses.', name: 'Anneau des Braises', description: 'Dégâts de feu +5%.', rarity: ItemRarity.UNCOMMON, type: ItemType.RING, icon: 'item_flame_ring', value: 200, element: ElementType.FIRE, bonusStats: { int: 2, magicAtk: 3 }, equipRanges: { mainStat: { key: 'MATK_FLAT', min: 7, max: 9 }, substats: [{ key: 'ELEM_BONUS_PCT', min: 4, max: 6, isPercentage: true }, { key: 'MANA_FLAT', min: 10, max: 14 }] } },
  ...
  { id: 'ring_of_the_wind', lore: 'Forgé dans un temple flottant, à une altitude où tout pèse moins. Il n\'a jamais accepté de redescendre.', name: 'Anneau du Vent', description: 'Du domaine de Sylvael. On se sent plus léger.', rarity: ItemRarity.EPIC, type: ItemType.RING, icon: 'item_wind_ring', value: 2200, element: ElementType.WIND, bonusStats: { agi: 6, spd: 4 }, passiveEffect: 'DASH_DISTANCE_20_PCT', equipRanges: { mainStat: { key: 'SPD_FLAT', min: 5, max: 8 }, substats: [{ key: 'ASPD_PCT', min: 8, max: 14, isPercentage: true }, { key: 'DODGE_PCT', min: 3, max: 5, isPercentage: true }, { key: 'ELEM_BONUS_PCT', min: 8, max: 14, isPercentage: true }, { key: 'MANA_FLAT', min: 21, max: 35 }] } },
  { id: 'tidal_ring', lore: 'Thalymor n\'a jamais été en retard. L\'anneau bat encore à son heure.', name: 'Anneau des Marées', description: 'Pulse comme une marée.', rarity: ItemRarity.EPIC, type: ItemType.RING, icon: 'item_tidal_ring', value: 2400, element: ElementType.WATER, bonusStats: { int: 5, vit: 4 }, passiveEffect: 'HEAL_SKILL_20_PCT', equipRanges: { mainStat: { key: 'HP_FLAT', min: 47, max: 79 }, substats: [{ key: 'MANA_FLAT', min: 21, max: 35 }, { key: 'HP_PCT', min: 5, max: 9, isPercentage: true }, { key: 'CDR_PCT', min: 4, max: 7, isPercentage: true }, { key: 'ELEM_BONUS_PCT', min: 8, max: 14, isPercentage: true }] } },
  { id: 'eye_of_the_storm_ring', lore: 'Au centre exact de la tempête, il y a un endroit calme. Volkran y rangeait ce qu\'il voulait garder.', name: 'Œil de la Tempête', description: 'Vous êtes le centre calme. Tout le reste tourne autour de vous.', rarity: ItemRarity.LEGENDARY, type: ItemType.RING, icon: 'item_storm_ring', value: 7000, element: ElementType.LIGHTNING, bonusStats: { int: 8, agi: 6, str: 4 }, passiveEffect: 'LIGHTNING_DMG_STUNNED_20_PCT', equipRanges: { mainStat: { key: 'MATK_FLAT', min: 16, max: 30 }, substats: [{ key: 'CRIT_RATE', min: 5, max: 10, isPercentage: true }, { key: 'ELEM_BONUS_PCT', min: 11, max: 20, isPercentage: true }, { key: 'CDR_PCT', min: 5, max: 10, isPercentage: true }, { key: 'MANA_FLAT', min: 27, max: 49 }, { key: 'ASPD_PCT', min: 11, max: 20, isPercentage: true }] } },
  ...
  { id: 'shadow_ring', lore: 'Froid avant la Spire, froid avant Malachar. Certaines choses n\'ont pas besoin d\'excuse.', name: 'Anneau des Ombres', description: 'Froid au toucher. A toujours été froid.', rarity: ItemRarity.RARE, type: ItemType.RING, icon: 'item_shadow_ring', value: 420, element: ElementType.DARK, bonusStats: { agi: 3, int: 3 }, equipRanges: { mainStat: { key: 'MATK_FLAT', min: 10, max: 14 }, substats: [{ key: 'CRIT_RATE', min: 3, max: 5, isPercentage: true }, { key: 'ELEM_BONUS_PCT', min: 5, max: 7, isPercentage: true }, { key: 'SPD_FLAT', min: 2, max: 4 }] } },
  { id: 'wraith_amulet', lore: 'Il l\'avait sur lui en mourant. La mort n\'a pas jugé utile de le rendre.', name: 'Bracelet du Fantôme', description: 'Porté par le revenant qui hantait les grottes de son vivant.', rarity: ItemRarity.RARE, type: ItemType.RING, icon: 'item_wraith_band', value: 460, bonusStats: { int: 4, agi: 2 }, equipRanges: { mainStat: { key: 'MATK_FLAT', min: 10, max: 14 }, substats: [{ key: 'MANA_FLAT', min: 16, max: 24 }, { key: 'DODGE_PCT', min: 2, max: 4, isPercentage: true }, { key: 'SPD_FLAT', min: 3, max: 5 }] } },

  // Amulets
  { id: 'wraith_ice_amulet', lore: 'Le blizzard y tient tout entier, replié. Ne l\'écoutez pas trop longtemps.', name: 'Amulette du Fantôme Blizzard', description: 'Le froid de Glaciem sous forme condensée.', rarity: ItemRarity.RARE, type: ItemType.AMULET, icon: 'item_blizzard_amulet', value: 500, element: ElementType.ICE, bonusStats: { int: 4, end: 2 }, equipRanges: { mainStat: { key: 'MATK_FLAT', min: 11, max: 17 }, substats: [{ key: 'ELEM_BONUS_PCT', min: 6, max: 8, isPercentage: true }, { key: 'MANA_FLAT', min: 16, max: 24 }, { key: 'HP_FLAT', min: 28, max: 42 }] } },
  { id: 'frozen_heart_amulet', lore: 'Il bat une fois par heure, exactement. Personne ne sait pour qui.', name: 'Cœur Gelé', description: 'Le cœur d\'un dragon de cristal, préservé dans la glace. Bat encore.', rarity: ItemRarity.EPIC, type: ItemType.AMULET, icon: 'item_frozen_heart', value: 2600, element: ElementType.ICE, bonusStats: { int: 6, vit: 5, end: 3 }, passiveEffect: 'ICE_SLOW_15_PCT', equipRanges: { mainStat: { key: 'HP_FLAT', min: 47, max: 79 }, substats: [{ key: 'MATK_FLAT', min: 13, max: 21 }, { key: 'ELEM_BONUS_PCT', min: 8, max: 14, isPercentage: true }, { key: 'MDEF_FLAT', min: 8, max: 14 }, { key: 'MANA_FLAT', min: 21, max: 35 }] } },
...
export const EXTRA_WEAPONS: Weapon[] = [
  ...
  { id: 'pyroclast_bow', lore: 'Monté avec des nerfs de wyrm par un chasseur d\'Ashford. Il ne ratait jamais les braises en vol.', name: 'Arc Pyroclaste', description: 'Flèches incandescentes qui explosent à l\'impact.', rarity: ItemRarity.EPIC, type: ItemType.WEAPON, icon: 'item_pyroclast_bow', value: 1900, element: ElementType.FIRE, weaponType: WeaponType.BOW, damage: 60, magicDamage: 50, bonusStats: { agi: 6, int: 4 }, attackSpeed: 1.0, equipRanges: { mainStat: { key: 'ATK_FLAT', min: 45, max: 75 }, substats: [{ key: 'ELEM_BONUS_PCT', min: 9, max: 15, isPercentage: true }, { key: 'CRIT_RATE', min: 5, max: 8, isPercentage: true }, { key: 'CRIT_DMG', min: 11, max: 19, isPercentage: true }, { key: 'ASPD_PCT', min: 5, max: 8, isPercentage: true }] } },
  // Earth
  ...
  { id: 'blizzard_greatsword', lore: 'Son sillage met des jours à fondre. Celui de son dernier porteur s\'arrête au milieu de la toundra.', name: 'Espadon des Blizzards', description: 'Laisse derrière lui un sillage de glace.', rarity: ItemRarity.EPIC, type: ItemType.WEAPON, icon: 'item_blizzard_gs', value: 1650, element: ElementType.ICE, weaponType: WeaponType.GREATSWORD, damage: 90, magicDamage: 40, bonusStats: { str: 7, int: 4, end: 3 }, attackSpeed: 0.62, equipRanges: { mainStat: { key: 'ATK_FLAT', min: 68, max: 113 }, substats: [{ key: 'ELEM_BONUS_PCT', min: 9, max: 15, isPercentage: true }, { key: 'ATK_PCT', min: 6, max: 10, isPercentage: true }, { key: 'CRIT_DMG', min: 14, max: 23, isPercentage: true }, { key: 'HP_FLAT', min: 53, max: 88 }] } },
  // Dark
  { id: 'shadow_staff', lore: 'La lumière qu\'il absorbe ne ressort nulle part. Les érudits préfèrent ne pas chercher où elle va.', name: 'Sceptre des Ombres', description: 'Semble absorber la lumière environnante.', rarity: ItemRarity.EPIC, type: ItemType.WEAPON, icon: 'item_shadow_staff', value: 2100, element: ElementType.DARK, weaponType: WeaponType.STAFF, damage: 15, magicDamage: 95, bonusStats: { int: 8, agi: 3 }, attackSpeed: 0.95, equipRanges: { mainStat: { key: 'MATK_FLAT', min: 71, max: 119 }, substats: [{ key: 'ELEM_BONUS_PCT', min: 9, max: 15, isPercentage: true }, { key: 'MATK_PCT', min: 7, max: 11, isPercentage: true }, { key: 'CRIT_RATE', min: 4, max: 6, isPercentage: true }, { key: 'LIFESTEAL_PCT', min: 2, max: 4, isPercentage: true }] } },
  { id: 'void_bow', lore: 'Les flèches n\'arrivent jamais. Quelque chose arrive à leur place.', name: 'Arc du Vide', description: 'Les flèches disparaissent. Les ennemis aussi.', rarity: ItemRarity.EPIC, type: ItemType.WEAPON, icon: 'item_void_bow', value: 2200, element: ElementType.DARK, weaponType: WeaponType.BOW, damage: 58, magicDamage: 60, bonusStats: { agi: 7, int: 5 }, attackSpeed: 1.1, equipRanges: { mainStat: { key: 'ATK_FLAT', min: 44, max: 73 }, substats: [{ key: 'ELEM_BONUS_PCT', min: 9, max: 15, isPercentage: true }, { key: 'CRIT_DMG', min: 14, max: 23, isPercentage: true }, { key: 'LIFESTEAL_PCT', min: 2, max: 4, isPercentage: true }, { key: 'ASPD_PCT', min: 5, max: 8, isPercentage: true }] } },
  // Divine
  { id: 'divine_sword', name: 'Épée Sacrée', description: 'Brille d\'une lumière douce. Les démons la fuient.', rarity: ItemRarity.LEGENDARY, type: ItemType.WEAPON, icon: 'item_divine_sword', value: 9500, element: ElementType.DIVINE, weaponType: WeaponType.SWORD, damage: 90, magicDamage: 90, bonusStats: { str: 8, int: 8, vit: 5 }, attackSpeed: 1.1, equipRanges: { mainStat: { key: 'ATK_FLAT', min: 63, max: 117 }, substats: [{ key: 'MATK_FLAT', min: 25, max: 46 }, { key: 'CRIT_RATE', min: 6, max: 10, isPercentage: true }, { key: 'CRIT_DMG', min: 18, max: 33, isPercentage: true }, { key: 'HP_PCT', min: 4, max: 8, isPercentage: true }, { key: 'BOSS_DMG_PCT', min: 7, max: 12, isPercentage: true }] }, lore: 'La contre-réponse à Malachar, trouvée trop tard.' },
  ...
  { id: 'wind_bow', lore: 'Les guides des sommets s\'en servaient pour signaler les passages sûrs. Il n\'y a plus de passages sûrs.',      name: 'Arc des Sommets',     description: 'Léger comme l\'air de Zephyr Peaks.',       rarity: ItemRarity.UNCOMMON, type: ItemType.WEAPON, icon: 'item_wind_bow',      value: 220, element: ElementType.WIND,      weaponType: WeaponType.BOW,   damage: 30, magicDamage: 18, bonusStats: { agi: 3 }, attackSpeed: 1.3, equipRanges: { mainStat: { key: 'ATK_FLAT', min: 26, max: 35 }, substats: [{ key: 'ASPD_PCT', min: 7, max: 9, isPercentage: true }, { key: 'ELEM_BONUS_PCT', min: 5, max: 7, isPercentage: true }] } },
  ...
  { id: 'thunder_staff', lore: 'Les orages de Volterra le trouvent, où qu\'il soit. Son porteur apprend à marcher vite.', name: 'Sceptre de Foudre',   description: 'Attire les éclairs de Volterra.',           rarity: ItemRarity.UNCOMMON, type: ItemType.WEAPON, icon: 'item_thunder_staff', value: 240, element: ElementType.LIGHTNING, weaponType: WeaponType.STAFF, damage: 5,  magicDamage: 45, bonusStats: { int: 4 }, attackSpeed: 0.9, equipRanges: { mainStat: { key: 'MATK_FLAT', min: 38, max: 52 }, substats: [{ key: 'ELEM_BONUS_PCT', min: 6, max: 8, isPercentage: true }, { key: 'CRIT_RATE', min: 2, max: 3, isPercentage: true }] } },
  ...
  { id: 'earth_tome', lore: 'Recopié à la main par des générations de géomanciens. La dernière main s\'est arrêtée en milieu de page.',    name: 'Tome de la Terre',    description: 'Recueil de sorts géomantiques de Terravast.',rarity: ItemRarity.UNCOMMON, type: ItemType.WEAPON, icon: 'item_earth_tome',    value: 210, element: ElementType.EARTH,     weaponType: WeaponType.STAFF, damage: 4,  magicDamage: 38, bonusStats: { int: 3, end: 1 }, attackSpeed: 0.85, equipRanges: { mainStat: { key: 'MATK_FLAT', min: 32, max: 44 }, substats: [{ key: 'ELEM_BONUS_PCT', min: 5, max: 7, isPercentage: true }, { key: 'DEF_FLAT', min: 5, max: 7 }] } },
];
...
export const EXTRA_ARMORS: Armor[] = [
  ...
  { id: 'iron_legs', lore: 'Le fer ralentit le pas. Ceux qui reviennent des zones disent que c\'est un prix honnête.', name: 'Jambières de Fer', description: 'Standard de fer.', rarity: ItemRarity.UNCOMMON, type: ItemType.LEGS, icon: 'item_iron_legs', value: 75, defense: 14, magicDefense: 4, bonusStats: { end: 1 }, equipRanges: { mainStat: { key: 'DEF_FLAT', min: 5, max: 7 }, substats: [{ key: 'HP_FLAT', min: 29, max: 39 }, { key: 'DEF_PCT', min: 3, max: 4, isPercentage: true }] } },
  { id: 'fire_legs', lore: 'Trempées dans la coulée, refroidies dans la cendre. Ignis Reach ne fait pas de demi-mesures.', name: 'Jambières Ignées', description: 'Forgées dans la lave d\'Ignis Reach.', rarity: ItemRarity.RARE, type: ItemType.LEGS, icon: 'item_fire_legs', value: 400, element: ElementType.FIRE, defense: 24, magicDefense: 10, bonusStats: { end: 2, str: 1 }, equipRanges: { mainStat: { key: 'DEF_FLAT', min: 7, max: 11 }, substats: [{ key: 'HP_FLAT', min: 36, max: 54 }, { key: 'MDEF_FLAT', min: 6, max: 10 }, { key: 'ELEM_BONUS_PCT', min: 6, max: 10, isPercentage: true }] } },
  ...
  { id: 'water_legs', lore: 'Le corail plie avec le courant. Les artisans de Saltmourn n\'ont eu qu\'à l\'écouter.', name: 'Jambières Corallines', description: 'Corail d\'Abyssmar, souple et résistant.', rarity: ItemRarity.RARE, type: ItemType.LEGS, icon: 'item_water_legs', value: 390, element: ElementType.WATER, defense: 20, magicDefense: 16, bonusStats: { end: 2, int: 1 }, equipRanges: { mainStat: { key: 'DEF_FLAT', min: 6, max: 10 }, substats: [{ key: 'MDEF_FLAT', min: 6, max: 10 }, { key: 'HP_FLAT', min: 36, max: 54 }, { key: 'MANA_FLAT', min: 16, max: 24 }] } },
  ...
  // Gloves extra
  { id: 'leather_gloves', lore: 'Ils prennent la forme des mains en une semaine. Après, ils refusent d\'en changer.', name: 'Gants de Cuir', description: 'Protection basique des mains.', rarity: ItemRarity.COMMON, type: ItemType.GLOVES, icon: 'item_leather_gloves', value: 18, defense: 3, magicDefense: 1, bonusStats: {}, equipRanges: { mainStat: { key: 'CRIT_RATE', min: 2, max: 3, isPercentage: true }, substats: [{ key: 'ATK_FLAT', min: 3, max: 4 }] } },
  { id: 'iron_gauntlets', lore: 'On y perd le toucher, on y garde ses doigts. Le marché est ancien.', name: 'Gantelets de Fer', description: 'Robustes et lourds.', rarity: ItemRarity.UNCOMMON, type: ItemType.GLOVES, icon: 'item_iron_gauntlets', value: 70, defense: 10, magicDefense: 3, bonusStats: { str: 1 }, equipRanges: { mainStat: { key: 'ATK_FLAT', min: 5, max: 7 }, substats: [{ key: 'DEF_FLAT', min: 5, max: 7 }, { key: 'HP_FLAT', min: 29, max: 39 }] } },
  ...
  // Helms extra
  { id: 'fire_helm', name: 'Heaume Igné', description: 'La chaleur lui fait comme une couronne.', rarity: ItemRarity.RARE, type: ItemType.HELM, icon: 'item_fire_helm', value: 420, element: ElementType.FIRE, defense: 20, magicDefense: 8, bonusStats: { end: 2 }, lore: 'Le forgeron n\'a jamais réussi à éteindre la braise en son centre. Il a fini par arrêter d\'essayer.', equipRanges: { mainStat: { key: 'HP_PCT', min: 5, max: 7, isPercentage: true }, substats: [{ key: 'DEF_FLAT', min: 6, max: 10 }, { key: 'HP_FLAT', min: 36, max: 54 }, { key: 'MDEF_FLAT', min: 6, max: 10 }] } },
  { id: 'earth_helm', name: 'Heaume de Terravast', description: 'Crystal sur cuir endurci.', rarity: ItemRarity.RARE, type: ItemType.HELM, icon: 'item_earth_helm', value: 410, element: ElementType.EARTH, defense: 25, magicDefense: 6, bonusStats: { end: 2, str: 1 }, lore: 'Le cristal pulse doucement quand la terre de Terravast tremble au loin.', equipRanges: { mainStat: { key: 'HP_PCT', min: 5, max: 7, isPercentage: true }, substats: [{ key: 'DEF_FLAT', min: 6, max: 10 }, { key: 'DEF_PCT', min: 4, max: 6, isPercentage: true }, { key: 'HP_FLAT', min: 36, max: 54 }] } },
  { id: 'wind_helm', name: 'Heaume du Vent', description: 'Aussi aérien qu\'une plume de Sylvael.', rarity: ItemRarity.RARE, type: ItemType.HELM, icon: 'item_wind_helm', value: 390, element: ElementType.WIND, defense: 16, magicDefense: 10, bonusStats: { agi: 3 }, lore: 'On l\'oublie sur la tête. C\'est bien le but.', equipRanges: { mainStat: { key: 'HP_PCT', min: 5, max: 7, isPercentage: true }, substats: [{ key: 'SPD_FLAT', min: 3, max: 5 }, { key: 'DODGE_PCT', min: 2, max: 4, isPercentage: true }, { key: 'DEF_FLAT', min: 6, max: 10 }] } },
  { id: 'water_helm', name: 'Heaume Marin', description: 'Casque de pillard des mers, cornes et grille de fer inclus.', rarity: ItemRarity.RARE, type: ItemType.HELM, icon: 'item_water_helm', value: 400, element: ElementType.WATER, defense: 18, magicDefense: 12, bonusStats: { end: 1, int: 2 }, lore: 'Récupéré sur l\'épave d\'un drakkar échoué à Abyssmar. Le sel n\'a jamais réussi à le ronger.', equipRanges: { mainStat: { key: 'HP_PCT', min: 5, max: 7, isPercentage: true }, substats: [{ key: 'MDEF_FLAT', min: 6, max: 10 }, { key: 'HP_FLAT', min: 36, max: 54 }, { key: 'MANA_FLAT', min: 16, max: 24 }] } },
  { id: 'lightning_helm', name: 'Heaume du Foudroiement', description: 'Canalise sans griller.', rarity: ItemRarity.RARE, type: ItemType.HELM, icon: 'item_lightning_helm', value: 430, element: ElementType.LIGHTNING, defense: 18, magicDefense: 12, bonusStats: { agi: 2, int: 2 }, lore: 'Un léger bourdonnement, en permanence. On finit par ne plus l\'entendre.', equipRanges: { mainStat: { key: 'HP_PCT', min: 5, max: 7, isPercentage: true }, substats: [{ key: 'MDEF_FLAT', min: 6, max: 10 }, { key: 'SPD_FLAT', min: 3, max: 5 }, { key: 'MANA_FLAT', min: 16, max: 24 }] } },
  { id: 'dark_helm', name: 'Heaume du Vide', description: 'Masque les traits du porteur.', rarity: ItemRarity.EPIC, type: ItemType.HELM, icon: 'item_dark_helm', value: 1500, element: ElementType.DARK, defense: 28, magicDefense: 24, bonusStats: { int: 5, agi: 3 }, lore: 'Personne ne se souvient du visage sous ce casque. Peut-être qu\'il n\'y en a plus.', equipRanges: { mainStat: { key: 'HP_PCT', min: 6, max: 10, isPercentage: true }, substats: [{ key: 'MDEF_FLAT', min: 8, max: 14 }, { key: 'HP_FLAT', min: 47, max: 79 }, { key: 'MATK_FLAT', min: 13, max: 21 }, { key: 'DODGE_PCT', min: 3, max: 5, isPercentage: true }] } },
  // Boots extra
  { id: 'iron_boots', lore: 'On les entend arriver de loin. C\'est parfois le but.', name: 'Bottes de Fer', description: 'Lourdes mais solides.', rarity: ItemRarity.UNCOMMON, type: ItemType.BOOTS, icon: 'item_iron_boots', value: 65, defense: 8, magicDefense: 3, bonusStats: { end: 1 }, equipRanges: { mainStat: { key: 'SPD_FLAT', min: 3, max: 4 }, substats: [{ key: 'DEF_FLAT', min: 5, max: 7 }, { key: 'HP_FLAT', min: 29, max: 39 }] } },
  ...
  // Capes extra
  { id: 'fire_cape', lore: 'Le tissu a déjà brûlé une fois. Il a décidé que ce serait la seule.', name: 'Cape de Cendres', description: 'Tissu noir calciné qui protège des flammes.', rarity: ItemRarity.RARE, type: ItemType.CAPE, icon: 'item_fire_cape', value: 360, element: ElementType.FIRE, defense: 12, magicDefense: 14, bonusStats: { end: 2 }, equipRanges: { mainStat: { key: 'MDEF_FLAT', min: 6, max: 10 }, substats: [{ key: 'HP_FLAT', min: 36, max: 54 }, { key: 'DEF_FLAT', min: 6, max: 10 }, { key: 'ELEM_BONUS_PCT', min: 6, max: 10, isPercentage: true }] } },
  { id: 'earth_cape', lore: 'Les runes cousues sont des copies de copies. Il reste quand même quelque chose de la phrase d\'origine.', name: 'Cape de Rune', description: 'Runes anciennes cousues dans le tissu.', rarity: ItemRarity.RARE, type: ItemType.CAPE, icon: 'item_earth_cape', value: 340, element: ElementType.EARTH, defense: 14, magicDefense: 10, bonusStats: { end: 2, str: 1 }, equipRanges: { mainStat: { key: 'DEF_FLAT', min: 6, max: 10 }, substats: [{ key: 'HP_FLAT', min: 36, max: 54 }, { key: 'MDEF_FLAT', min: 6, max: 10 }, { key: 'DEF_PCT', min: 4, max: 6, isPercentage: true }] } },
  { id: 'water_cape', lore: 'Le sang glisse dessus comme la pluie. Les gardes-mer y tenaient beaucoup.', name: 'Cape des Profondeurs', description: 'Imperméable à l\'eau et au sang.', rarity: ItemRarity.RARE, type: ItemType.CAPE, icon: 'item_water_cape', value: 350, element: ElementType.WATER, defense: 12, magicDefense: 16, bonusStats: { vit: 2, int: 1 }, equipRanges: { mainStat: { key: 'MDEF_FLAT', min: 6, max: 10 }, substats: [{ key: 'HP_FLAT', min: 36, max: 54 }, { key: 'HP_PCT', min: 4, max: 6, isPercentage: true }, { key: 'MANA_FLAT', min: 16, max: 24 }] } },
  ...
  { id: 'dark_cape', lore: 'Dans le noir, elle disparaît. Le porteur aussi — en partie.', name: 'Cape des Ombres', description: 'Se fond dans l\'obscurité.', rarity: ItemRarity.EPIC, type: ItemType.CAPE, icon: 'item_dark_cape', value: 1600, element: ElementType.DARK, defense: 16, magicDefense: 20, bonusStats: { agi: 5, int: 4 }, equipRanges: { mainStat: { key: 'MDEF_FLAT', min: 8, max: 14 }, substats: [{ key: 'DODGE_PCT', min: 3, max: 5, isPercentage: true }, { key: 'SPD_FLAT', min: 4, max: 7 }, { key: 'HP_FLAT', min: 47, max: 79 }, { key: 'MATK_FLAT', min: 13, max: 21 }] } },
  { id: 'divine_cape', lore: 'Tissée d\'un fil de lumière laissé par une divinité morte. Le tisserand a pleuré tout du long, sans savoir pourquoi.', name: 'Cape de Lumière', description: 'Tissu divin que les ombres fuient.', rarity: ItemRarity.LEGENDARY, type: ItemType.CAPE, icon: 'item_divine_cape', value: 7000, element: ElementType.DIVINE, defense: 22, magicDefense: 35, bonusStats: { vit: 6, int: 5, end: 4 }, equipRanges: { mainStat: { key: 'MDEF_FLAT', min: 11, max: 20 }, substats: [{ key: 'HP_FLAT', min: 60, max: 111 }, { key: 'HP_PCT', min: 7, max: 12, isPercentage: true }, { key: 'MANA_FLAT', min: 27, max: 49 }, { key: 'DEF_FLAT', min: 11, max: 20 }, { key: 'CDR_PCT', min: 5, max: 10, isPercentage: true }] } },
  // Zone chest rewards (referenced by zoneMaps lootable pools)
  { id: 'volcanic_armor', lore: 'Forgée si près du cratère que le marteau sonnait faux. Elle a gardé la note.',   name: 'Armure Volcanique',  description: 'Forgée dans le magma d\'Ignis Reach.',    rarity: ItemRarity.RARE, type: ItemType.CHEST, icon: 'item_fire_chest',     value: 450, element: ElementType.FIRE,      defense: 28, magicDefense: 10, bonusStats: { end: 2, str: 2 }, equipRanges: { mainStat: { key: 'DEF_FLAT', min: 8, max: 12 }, substats: [{ key: 'HP_FLAT', min: 36, max: 54 }, { key: 'MDEF_FLAT', min: 6, max: 10 }, { key: 'ELEM_BONUS_PCT', min: 6, max: 10, isPercentage: true }] } },
...
const SHOP_ARMORS: Armor[] = [
  { id: 'leather_armor', lore: 'Le tanneur ne souhaite jamais bonne chance à ceux qui l\'achètent. Il dit seulement : revenez.', name: 'Armure de Cuir', description: 'Armure légère en cuir tanné. Fiable pour débuter.', rarity: ItemRarity.COMMON, type: ItemType.CHEST, icon: 'item_leather_chest', value: 55, defense: 8, magicDefense: 3, bonusStats: {}, equipRanges: { mainStat: { key: 'DEF_FLAT', min: 4, max: 5 }, substats: [{ key: 'HP_FLAT', min: 20, max: 25 }] } },
