...
export const ACCESSORIES: Accessory[] = [
  ...
  { id: 'eternal_flame_ring', lore: 'Allumé au dernier feu sacré de Pyrath. Tant qu\'il brûle, quelque chose du dieu n\'est pas tout à fait mort.', name: 'Anneau de la Flamme Éternelle', description: 'La flamme ne s\'éteint jamais. Vous non plus.', rarity: ItemRarity.EPIC, type: ItemType.RING, icon: 'item_eternal_ring', value: 2000, element: ElementType.FIRE, bonusStats: { int: 5, vit: 4, magicAtk: 8 }, passiveEffect: 'Fire skills cooldown reduced by 15%.' },
  { id: 'ring_of_the_wind', lore: 'Forgé dans un temple flottant, à une altitude où tout pèse moins. Il n\'a jamais accepté de redescendre.', name: 'Anneau du Vent', description: 'Du domaine de Sylvael. On se sent plus léger.', rarity: ItemRarity.EPIC, type: ItemType.RING, icon: 'item_wind_ring', value: 2200, element: ElementType.WIND, bonusStats: { agi: 6, spd: 4 }, passiveEffect: 'Dash distance +20%.' },
  { id: 'tidal_ring', lore: 'Thalymor n\'a jamais été en retard. L\'anneau bat encore à son heure.', name: 'Anneau des Marées', description: 'Pulse comme une marée.', rarity: ItemRarity.EPIC, type: ItemType.RING, icon: 'item_tidal_ring', value: 2400, element: ElementType.WATER, bonusStats: { int: 5, vit: 4 }, passiveEffect: 'Healing skills +20% effectiveness.' },
  { id: 'eye_of_the_storm_ring', lore: 'Au centre exact de la tempête, il y a un endroit calme. Volkran y rangeait ce qu\'il voulait garder.', name: 'Œil de la Tempête', description: 'Vous êtes le centre calme. Tout le reste tourne autour de vous.', rarity: ItemRarity.LEGENDARY, type: ItemType.RING, icon: 'item_storm_ring', value: 7000, element: ElementType.LIGHTNING, bonusStats: { int: 8, agi: 6, str: 4 }, passiveEffect: 'Lightning skills deal 20% more damage to stunned targets.' },
  ...
  { id: 'frozen_heart_amulet', lore: 'Il bat une fois par heure, exactement. Personne ne sait pour qui.', name: 'Cœur Gelé', description: 'Le cœur d\'un dragon de cristal, préservé dans la glace. Bat encore.', rarity: ItemRarity.EPIC, type: ItemType.AMULET, icon: 'item_frozen_heart', value: 2600, element: ElementType.ICE, bonusStats: { int: 6, vit: 5, end: 3 }, passiveEffect: 'Ice skills slow amount +15%.' },
