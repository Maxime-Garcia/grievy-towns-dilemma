...
export const EXTRA_WEAPONS: Weapon[] = [
  ...
  { id: 'test_dual_dagger', name: 'Dagues Jumelles',   description: 'Une paire de dagues assorties, prises à un même fourreau.', rarity: ItemRarity.COMMON, type: ItemType.WEAPON, icon: 'item_test_dual_dagger', value: 10, weaponType: WeaponType.DUAL_DAGGER, damage: 20, magicDamage: 0, bonusStats: {}, attackSpeed: 1.5, equipStats: { mainStat: { key: 'ATK_FLAT', value: 20 }, substats: [{ key: 'ASPD_PCT', value: 6, isPercentage: true }] } },
  { id: 'test_dual_sword',  name: 'Lames Croisées',    description: 'Deux lames courtes, faites pour frapper en même temps.',  rarity: ItemRarity.COMMON, type: ItemType.WEAPON, icon: 'item_test_dual_sword',  value: 10, weaponType: WeaponType.DUAL_SWORD,  damage: 25, magicDamage: 0, bonusStats: {}, attackSpeed: 1.0, equipStats: { mainStat: { key: 'ATK_FLAT', value: 25 }, substats: [{ key: 'CRIT_RATE', value: 2, isPercentage: true }] } },
  { id: 'test_axe',         name: 'Hache de Bûcheron', description: 'Simple, robuste, encore couverte de sève séchée.',        rarity: ItemRarity.COMMON, type: ItemType.WEAPON, icon: 'item_test_axe',         value: 10, weaponType: WeaponType.AXE,         damage: 30, magicDamage: 0, bonusStats: {}, attackSpeed: 0.9, equipStats: { mainStat: { key: 'ATK_FLAT', value: 30 }, substats: [{ key: 'ATK_PCT', value: 3, isPercentage: true }] } },
  { id: 'test_hammer',      name: 'Marteau de Forge',  description: 'Emprunté à une forge. Lourd, mais ça ne pardonne pas.',   rarity: ItemRarity.COMMON, type: ItemType.WEAPON, icon: 'item_test_hammer',      value: 10, weaponType: WeaponType.HAMMER,      damage: 35, magicDamage: 0, bonusStats: {}, attackSpeed: 0.7, equipStats: { mainStat: { key: 'ATK_FLAT', value: 35 }, substats: [{ key: 'HP_FLAT', value: 25 }] } },
